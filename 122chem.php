...
$sql = "SELECT * From chem122posting_mcqs WHERE school='$school' AND paper_yr='$paper_yr'";
$result = mysqli_query($conn,$sql);
$queryResults = mysqli_num_rows($result);
if ($queryResults > 0 ) {
while ($row = mysqli_fetch_assoc($result)) {
echo "<title>".$row['school']." ".$row['paper_yr']." grade 12 second term test chemistry MCQ answers </title>
   <meta name='description' content='Accurate MCQ answers for ".$row['school']." ".$row['paper_yr']." grade 12 second term test chemistry paper'>";
}
}
                }?>
</head>
...
(adsbygoogle = window.adsbygoogle || []).push({});
                  ...
                  <form method='POST' action='includes/12secondchemrec_ans.php'>
 ...
 <?php
include 'scriptcode/2buttonscript.php';
 ?>
<?php
include 'footer.php';
?>
