...
?>
         ...
         if (isset($_POST['submit'])) {
            ...
            $search3 = mysqli_real_escape_string($conn,$_POST['dropt']);
         	if ($search2 == "null" && $search1 !== "null" && $search3 == "null") {
         		$sql = "SELECT * FROM phy123  WHERE paper_yr='$search1' ;";
	...
	if ($queryResults > 0 ) {
		...
		";
            ...
            $sql = "SELECT * FROM phy123  WHERE  school='$search2' ;";
  ...
  if ($queryResults > 0 ) {
    ...
    ";
          ...
          echo "<div id='idnothing'><p>No results... :(</p></div>";
                  ...
                  elseif ($search2 == "null" && $search1 == "null" && $search3 !== "null") {
            $sql = "SELECT * FROM phy123  WHERE  papert='$search3';";
  ...
  if ($queryResults > 0 ) {
    ...
    ";
       ...
       elseif($search1 !== "null" && $search2 !== "null" && $search3 == "null") {
       	$sql = "SELECT * FROM phy123  WHERE paper_yr='$search1' AND school='$search2' ;";
 ...
 <p id='thanks'>".$row['user'] . " </p>
    ...
    ";
      ...
      elseif($search3 !== "null" && $search1 !== "null" && $search2 == "null" ) {
        $sql = "SELECT * FROM phy123  WHERE papert='$search3' AND paper_yr='$search1' ;";
 ...
 <p id='thanks'>".$row['user'] . " </p>
    ...
    ";
      ...
      elseif( $search2 !== "null" && $search3 !== "null" && $search1 == "null") {
        $sql = "SELECT * FROM phy123  WHERE  school='$search2' AND  papert='$search3';";
  ...
  if ($queryResults > 0 ) {
   ...
   <p id='thanks'>".$row['user'] . " </p>
    ...
    ";
      ...
      elseif ($search1 !== "null" && $search2 !== "null" && $search3 !== "null") {
        $sql = "SELECT * FROM phy123  WHERE paper_yr='$search1' AND school='$search2' AND  papert='$search3';";
