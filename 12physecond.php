...
?>
<title>A/Ls-grade 12 second term test physics MCQ answers of Royal college,Visakha Vidayalya,Ananda college,Devi Balika Vidyalaya etc</title>
    <meta name="description" content="Accurate answers for A/L grade 12 second term test physics MCQ papers of Royal college,Visakha Vidayalya,Ananda college,Devi Balika Vidyalaya etc ">
</head>
<?php
include 'rest.php';
?>
	...
	<div id="searchcon">
		...
		<form action="12physecondsearch" method="POST">
			...
			<div id="uploadId"><a href="12physecondupload">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<?php
	$sql = "SELECT * From phy122posting_mcqs ORDER BY paper_yr DESC";
