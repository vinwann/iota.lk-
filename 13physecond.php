...
?>
<title>A/Ls-grade 13 second term test physics MCQ answers of Royal college,Visakha Vidayalya,Ananda college,Devi Balika Vidyalaya etc</title>
    <meta name="description" content="Accurate answers for A/L grade 13 second term test physics MCQ papers of Royal college,Visakha Vidayalya,Ananda college,Devi Balika Vidyalaya etc ">
...
?>
	...
	<div id="searchcon">
		...
		<form action="13physecondsearch" method="POST">
			...
			<div id="uploadId"><a href="13physecondupload">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<?php
	$sql = "SELECT * From phy132posting_mcqs ORDER BY paper_yr DESC";
	$result = mysqli_query($conn,$sql);
	$queryResults = mysqli_num_rows($result);
	if ($queryResults > 0 ) {
		while ($row = mysqli_fetch_assoc($result)) {
			echo "
		<a href='132phy?school=".$row['school']."&paper_yr=".$row['paper_yr']."'' class='mcqAcn'>
     	    <div class='mcqBox'>
