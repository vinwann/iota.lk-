...
?>
<title>Download A/Ls-grade 12 first term test chemistry papers of Royal college,Visakha Vidayalya,Ananda college,Devi Balika Vidyalaya etc</title>
    <meta name="description" content="Download A/Ls-grade 12 first term test MCQ and ESSAY chemistry papers of Royal college,Visakha Vidayalya,Ananda college,Devi Balika Vidyalaya etc ">
...
?>
	<div id="searchcon">
		...
		<form action="chemtt121search" method="POST">
...
<?php 
 $sql = "SELECT * From chem121 ORDER BY paper_yr";
...
$queryResults = mysqli_num_rows($result);
 ...
 ?>
	...
	$sql = "SELECT * From chem121 ORDER BY paper_yr DESC";
	$result = mysqli_query($conn,$sql);
	$queryResults = mysqli_num_rows($result);
	if ($queryResults > 0 ) {
...
<?php
 include 'footer.php';
 //121chemtt?school=".$row['school']."&paper_yr=".$row['paper_yr']."&papert=".$row['papert']."
  ?>
