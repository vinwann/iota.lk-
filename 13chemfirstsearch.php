...
?>
		...
		<?php
         if (isset($_POST['submit'])) {
         	...
         	if ($search2 == "null" || $search1 == "null") {
         		$sql = "SELECT * FROM chem131posting_mcqs  WHERE paper_yr='$search1' OR school='$search2';";
	...
	if ($queryResults > 0 ) {
		...
		";
       	...
       	$sql = "SELECT * FROM chem131posting_mcqs  WHERE paper_yr='$search1' AND school='$search2';";
