...
?>
		...
		<?php
         if (isset($_POST['submit'])) {
         	...
         	if ($search2 == "null" || $search1 == "null") {
         		$sql = "SELECT * FROM chem122posting_mcqs  WHERE paper_yr='$search1' OR school='$search2';";
	...
	";
       	...
       	$sql = "SELECT * FROM chem122posting_mcqs  WHERE paper_yr='$search1' AND school='$search2';";
